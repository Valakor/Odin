...
foreign lib {
	...
	GameControllerGetSteamHandle        :: proc(gamecontroller: ^GameController) -> u64 ---
	...
	GameControllerGetSensorDataWithTimestamp :: proc(gamecontroller: ^GameController, type: SensorType, data: [^]f32, num_values: c.int) -> c.int ---
